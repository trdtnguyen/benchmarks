...
#similar with build_graph_stream_lba.sh except use lba instead of offset
infile=$1
coll1='collection/9'
coll2='collection/2'
coll3='collection/6'
...
plot '$filetemp11' u 1:2 ls 1 ti "streamid 3 coll 1", \
 '$filetemp21' u 1:2 ls 2 ti "streamid 4 coll 1";
set output '${outfile}_coll2.png';
plot '$filetemp12' u 1:2 ls 1 ti "streamid 3 coll 2", \
 '$filetemp22' u 1:2 ls 2 ti "streamid 4 coll 2";
