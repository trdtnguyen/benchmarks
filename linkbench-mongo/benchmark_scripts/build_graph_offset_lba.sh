...
#similar with build_graph_stream.sh except use lba instead of offset
infile=$1
coll1='collection/9'
coll2='collection/2'
coll3='collection/6'
...
set output '${outfile}_coll1.png';
plot '$filetemp11' u 1:2 ls 1 ti "streamid 3 coll 1", \
plot '$filetemp21' u 1:2 ls 2 ti "streamid 4 coll 1";
set output '${outfile}_coll2.png';
plot '$filetemp12' u 1:2 ls 1 ti "streamid 3 coll 2", \
plot '$filetemp22' u 1:2 ls 2 ti "streamid 4 coll 2";
set output '${outfile}_coll3.png';
plot '$filetemp13' u 1:2 ls 1 ti "streamid 3 coll 3", \
plot '$filetemp23' u 1:2 ls 2 ti "streamid 4 coll 3";


set output '${outfile}_idx1.png';
plot '$filetemp31' u 1:2 ls 1 ti "streamid 5 idx 1", \
plot '$filetemp41' u 1:2 ls 2 ti "streamid 6 idx 1";
set output '${outfile}_idx2.png';
plot '$filetemp32' u 1:2 ls 1 ti "streamid 5 idx 2", \
plot '$filetemp42' u 1:2 ls 2 ti "streamid 6 idx 2";
set output '${outfile}_idx3.png';
plot '$filetemp33' u 1:2 ls 1 ti "streamid 5 idx 3", \
plot '$filetemp43' u 1:2 ls 2 ti "streamid 6 idx 3";
set output '${outfile}_idx4.png';
plot '$filetemp34' u 1:2 ls 1 ti "streamid 5 idx 4", \
plot '$filetemp44' u 1:2 ls 2 ti "streamid 6 idx 4";
set output '${outfile}_idx5.png';
plot '$filetemp35' u 1:2 ls 1 ti "streamid 5 idx 5", \
plot '$filetemp45' u 1:2 ls 2 ti "streamid 6 idx 5";
set output '${outfile}_idx6.png';
plot '$filetemp36' u 1:2 ls 1 ti "streamid 5 idx 6", \
plot '$filetemp46' u 1:2 ls 2 ti "streamid 6 idx 6";
