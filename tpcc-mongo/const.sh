...
BENCHMARK_HOME=/ssd2/benchmark/tpcc-mongodb
TPCC_HOME=/home/vldb/py-tpcc/pytpcc
TPCC_CONFIG_FILE=${BENCHMARK_HOME}/mongodb.config
...
########################################
# TPCC overwriten cofig key-value

#number threads of loaders
#TPCC_LOAD_THREADS=20
TPCC_LOAD_THREADS=1
TPCC_RUN_THREADS=20 #N
TPCC_WAREHOUSE=100 #W
TPCC_DURATION=3600 #D
#LB_MAX_TIME=3600
#LB_MAX_TIME=600
############################################
...
TPCC_SERVER_STATUS_LOAD=load_serverStatus.txt

TPCC_CUSTOMER_LOAD=load_customer_stats.txt
TPCC_DISTRICT_LOAD=load_district_stats.txt
TPCC_ITEM_LOAD=load_item_stats.txt
TPCC_NEW_ORDER_LOAD=load_new_order_stats.txt
TPCC_STOCK_LOAD=load_stock_stats.txt
TPCC_WAREHOUSE_LOAD=load_warehouse_stats.txt

TPCC_SERVER_STATUS_RUN=run_serverStatus.txt
TPCC_CUSTOMER_RUN=run_customer_stats.txt
TPCC_DISTRICT_RUN=run_district_stats.txt
TPCC_ITEM_RUN=run_item_stats.txt
TPCC_NEW_ORDER_RUN=run_new_order_stats.txt
TPCC_STOCK_RUN=run_stock_stats.txt
TPCC_WAREHOUSE_RUN=run_warehouse_stats.txt
